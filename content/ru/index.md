...
Можно самому поиграться в более продвинутых симуляторах, например [conwaylife.com](https://conwaylife.com/).
...
Клеточный автомат "Игра Жизнь" является Тьюринг-полным, то есть на нём можно построить компьютер, или машину Тьюринга, вот её пример: ([источник с интерактивной симуляцией](https://conwaylife.com/wiki/Turing_machine))

{{ image(path="game_of_life_turing_machine.png", scale="2/3") }}

---

В интерактивной визуализации [oimo.io/works/life](https://oimo.io/works/life/) (работает и с телефона), Игра Жизнь симулируется на самой себе как вглубь, бесконечно малое, так и ввысь, бесконечно большое:
...
Или вот пример искусственной химии, которую разработал [Tim Hutton](https://mathstodon.xyz/@timhutton), в которой он спроектировал такие элементы, и такие взаиомодействия между ними, чтобы собрать искусственную клетку, способную размножаться:

{{ video(path="chemistry.mp4", scale="2/3") }}

Это не клеточный автомат, но очень легко встаёт на его рельсы, и автор продолжает развивать эту идею в виде клеточного автомата: ([источник](https://github.com/timhutton/linear-enzymes))
...
{{ admonition_start(color="gray", title="💬 Цитата из статьи [Cellular automata with 2 temporal dimensions](http://dmishin.blogspot.com/2014/06/cellular-automata-with-2-temporal.html)") }}
...
{{ figure_end(caption="[xkcd/505](https://xkcd.ru/505/)") }}
{{ details_end() }}
...
{{ admonition_start(color="blue3", title="Пост в Telegram от [«я обучала одну модель»/927](https://t.me/def_model_train/927)") }}
...
> Одни лишь размышления, без наблюдения за реальностью, совершенно бесполезны при попытках выдать верный взгляд на реальность. Поэтому если вы не можете дать мне то что я не могу наблюдать, я знаю как заниматься здесь наукой. — [Джеймс Гейтс](https://www.youtube.com/embed/q6j5TFE_iCk)
...
* [The mathematical universe: the map that is the territory](https://www.lesswrong.com/posts/fZJRxYLtNNzpbWZAA/the-mathematical-universe-the-map-that-is-the-territory) — субстрат-независимость; независимое существование симулируемых вселенных; проблема багованных вселенных.
* [Statistical immportality](https://zachaysan.tumblr.com/post/7238016119/statistical-immortality) [(YC)](https://news.ycombinator.com/item?id=2727750) [(YC 2)](https://news.ycombinator.com/item?id=24385433) — невозможность смерти; проблема смены вселенных до смерти.
...
На [странице FAQ](https://www.gregegan.net/PERMUTATION/FAQ/FAQ.html) про Город Перестановок, Грег Иган говорит что сам не воспринимает эту теорию всерьёз из-за проблемы багованных вселенных, хотя не видел её иного опровержения.
{{ details_end() }}
...
* [\[29\]] Cellular automata with 2 temporal dimensions 