...
Но на самом деле такая интерпретация времени **наивна**, и она не позволяет существование гораздо более сложных вселенных, например:
